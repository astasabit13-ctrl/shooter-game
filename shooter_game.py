...
while run:
    ...
    if not finish:
        ...
        score_text = font1.render("Score : " + str(score), 1, (255, 255, 255))
        window.blit(score_text, (10, 20))
 
        lose_text = font1.render("Missed : " + str(lost), 1, (255, 255, 255))
        ...
        # bullet-monster collision check (both monster and bullet disappear)
        ...
        #possible lose: missed too many enemies or the player collided with the enemy
